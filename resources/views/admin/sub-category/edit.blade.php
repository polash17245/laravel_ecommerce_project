            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{route('sub-category.update', ['id' => $sub_category->id])}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            <label for="horizontal-firstname-input1" class="col-sm-3 col-form-label">Sub Category name</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" value="{{$sub_category->name}}" name="name" id="horizontal-firstname-input1"/>
                            </div>
                        </div>
                        <div class="form-group row mb-4">
